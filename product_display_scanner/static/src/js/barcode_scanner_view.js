        ...
        this.scanDebounceTimeout = setTimeout(async () => {
            ...
            const productData = await this.orm.searchRead(
                ...
                [
                    ...
                    'qty_available', 'product_tmpl_id','evaluation_id', 'uom_id',
                    'list_price', 'retail_price','secondary_quantity_total','secondary_uom'
                ],
                { limit: 1 }
            );
...
//                 console.error("Error fetching Retail Price from product:", error);
            ...
            if (product.evaluation_id) {
                const percentValue = Number(product.evaluation_id) / 100;
                finalPrice += finalPrice * percentValue;
            }

            priceFormatted = new Intl.NumberFormat(undefined, {
                style: 'currency',
            ...
            this.state.product = {
                ...
                secondary_name: product.secondary_uom[1]
            };
